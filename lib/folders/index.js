...
exports.create = function(options) {
  ...
  var importExcelToFolder = function(postOptions, callback) {
    optionsToSend.url = options.apiUrls.folders + postOptions.folderId + '/sheets/import';
    optionsToSend.contentType = constants.acceptHeaders.vndMsExcel;
    return utils.post(_.extend(optionsToSend, postOptions), callback);
  };
  ...
  var deleteFolders = function(deleteOptions, callback) {
  ...
  return {
    ...
    importExcelToFolder : importExcelToFolder,
