...
function makeRequestWithRetries(requestOptions, requestMethod, callback, options) {
  var maxRetryTime = options.maxRetryTime || constants.maxRetryTime;
...
function retryHelper(requestOptions, requestMethod, endRetryTime, calcBackoff, numRetries) {
...
function retryWithBackoffHelper(requestOptions, requestMethod, endRetryTime, calcBackoff, numRetries) {
    return function (error) {
      ...
      return Promise.delay(calcBackoff(numRetries))
        .then(function () {
          return retryHelper(requestOptions, requestMethod, endRetryTime, calcBackoff, numRetries + 1);
        });
    };
}
