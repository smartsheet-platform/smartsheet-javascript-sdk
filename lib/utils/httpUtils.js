...
exports.post = function(options, callback) {
  ...
  return makeRequest(requestOptions, request.postAsync, callback);
};
...
exports.delete = function(options, callback) {
  ...
  return makeRequest(requestOptions, request.delAsync, callback);
};
...
exports.put = function(options, callback) {
  ...
  return makeRequest(requestOptions, request.putAsync, callback);
};
...
function makeRequestWithRetries(requestOptions, requestMethod, callback, options) {
  ...
  return _retryHelper(requestOptions, requestMethod, callback, endRetryTime, calcBackoff, 0);
}

function _retryHelper(requestOptions, requestMethod, callback, endRetryTime, calcBackoff, numRetries) {
  return makeRequest(requestOptions, requestMethod, callback)
    .then(function(result) {
        return result;
    })
    .catch(retryWithBackoff(requestOptions, requestMethod, callback, endRetryTime, calcBackoff, numRetries));
}

function retryWithBackoff(requestOptions, requestMethod, callback, endRetryTime, calcBackoff, numRetries) {
    return function (error) {
      ...
      return Promise.delay(calcBackoff(numRetries))
        .then(function () {
          return _retryHelper(requestOptions, requestMethod, callback, endRetryTime, calcBackoff, numRetries + 1);
        });
    };
}
...
function makeRequest (requestOptions, requestMethod, callback) {
