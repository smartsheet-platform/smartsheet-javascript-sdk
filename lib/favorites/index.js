...
exports.create = function(options) {
  ...
  var addSightToFavorites = function(postOptions, callback) {
    postOptions.type = types.sight;
    return handleFavorites(postOptions, callback);
  };

  var removeFavorite = function(deleteOptions, callback) {
    deleteOptions.url = optionsToSend.url + deleteOptions.type + '/' + (deleteOptions.id || deleteOptions.objectId || '');
  ...
  var removeSightFromFavorites = function(deleteOptions, callback) {
    deleteOptions.type = types.sight;
    return removeFavorite(deleteOptions, callback);
  };
