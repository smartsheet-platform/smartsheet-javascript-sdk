...
exports.create = options => {
  ...
  var removeFavorite = (deleteOptions, callback) => {
    if (deleteOptions.queryParameters && (deleteOptions.queryParameters.objectIds instanceof Array)) {
      deleteOptions.queryParameters.objectIds = deleteOptions.queryParameters.objectIds.join(',');
    }
