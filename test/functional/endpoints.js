    ...
    var testGroups = [
        {
            ...
            methods: [
                ...
                { name: 'listContacts', stub: 'get', options: {}, expectedRequest: {url: "contacts/" }},
            ]
        },
        {
            name: 'favorites',
            methods: [
                { name: 'listFavorites', stub: 'get', options: {}, expectedRequest: {url: "favorites/" }},
                ...
                { name: 'removeSheetsFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/sheet/123" }},
                { name: 'removeFoldersFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/folder/123" }},
                { name: 'removeReportsFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/report/123" }},
                { name: 'removeTemplatesFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/template/123" }},
                { name: 'removeSightsFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/sight/123" }},
                { name: 'removeWorkspacesFromFavorites', stub: 'delete', options: { objectId: 123 }, expectedRequest: {url: "favorites/workspace/123" }},
                { name: 'removeWorkspacesFromFavorites', stub: 'delete', options: { id: 123 }, expectedRequest: {url: "favorites/workspace/123" }},
            ]
        },
        {
            name: 'folders',
        ...
        },
        {
            name: 'groups',
            methods: [
                { name: 'listGroups', stub: 'get', options: {}, expectedRequest: {url: "groups/" }},
        ...
        },
        {
            name: 'home',
            methods: [
                { name: 'listContents', stub: 'get', options: {}, expectedRequest: {url: "home/" }},
                { name: 'listFolders', stub: 'get', options: {}, expectedRequest: {url: "home/folders" }},
        ...
        },
        {
            ...
            methods: [
                ...
                { name: 'getReportAsExcel', stub: 'get', options: {}, expectedRequest: {url: "reports/", accept: constants.acceptHeaders.vndMsExcel }},
        ...
        },
        {
            name: 'server',
            methods: [
                { name: 'getInfo', stub: 'get', options: {}, expectedRequest: {url: "serverinfo/"}},
            ]
        },
        {
            name: 'sheets',
            methods: [
                ...
                { name: 'listSheets', stub: 'get', options: {}, expectedRequest: {url: "sheets/"}},
                { name: 'getSheetAsCSV', stub: 'get', options: {}, expectedRequest: {url: "sheets/", accept: constants.acceptHeaders.textCsv}},
                { name: 'getSheetAsExcel', stub: 'get', options: {}, expectedRequest: {url: "sheets/", accept: constants.acceptHeaders.vndMsExcel}},
                { name: 'getSheetAsPDF', stub: 'get', options: {}, expectedRequest: {url: "sheets/", accept: constants.acceptHeaders.applicationPdf}},
                { name: 'getSheetVersion', stub: 'get', options: {sheetId: 123}, expectedRequest: {url: "sheets/123/version"}},
                { name: 'listOrganizationSheets', stub: 'get', options: {}, expectedRequest: {url: "users/sheets"}},
                // rows
        ...
        },
        {
            name: 'sights',
            methods: [
                { name: 'listSights', stub: 'get', options: {}, expectedRequest: {url: "sights/"}},
        ...
        },
        {
            name: 'templates',
            methods: [
                { name: 'listUserCreatedTemplates', stub: 'get', options: {}, expectedRequest: {url: "templates/"}},
                { name: 'listPublicTemplates', stub: 'get', options: {}, expectedRequest: {url: "templates/public"}},
            ]
        },
        {
            name: 'tokens',
        ...
        },
        {
            ...
            methods: [
                ...
                { name: 'listAllUsers', stub: 'get', options: {}, expectedRequest: {url: "users/"}},
        ...
        },
        {
            ...
            methods: [
                ...
                { name: 'listWebhooks', stub: 'get', options: {}, expectedRequest: {url: "webhooks/" }},
        ...
        },
        {
            name: 'workspaces',
            methods: [
                { name: 'listWorkspaces', stub: 'get', options: {}, expectedRequest: {url: "workspaces/"}},
